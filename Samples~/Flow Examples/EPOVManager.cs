...
public class EPOVManager : UnitySingleton<EPOVManager>
{
    ...
    public InputAction _skipAction;
    ...
    private void Awake()
    {
        if (_getMetaphorFromConfigFile)
        {
            ...
            {
                var jm = FindObjectOfType<JoystickMoveProvider>();
    ...
    public bool SkipPressed()
    {
        if (_skipAction == null)
            return false;
        return _skipAction.ReadValue<bool>();
    ...
    public bool RepeatPressed()
    {
        ...
        return _repeatAction.ReadValue<bool>();
